...
PATH_Train = '/home/user/Desktop/Papers_codes/P3_WNO/WNO-master/data/piececonst_r421_N1024_smooth1.mat'
PATH_Test = '/home/user/Desktop/Papers_codes/P3_WNO/WNO-master/data/piececonst_r421_N1024_smooth2.mat'
ntrain = 1000
ntest = 100
...
for value in range(y_test.shape[0]):
    if value % 26 == 1:
        ...
        plt.imshow(x_test[value,:,:,0], cmap='jet', extent=[0,1,0,1], interpolation='Gaussian')
        ...
        plt.imshow(y_test[value,:,:], cmap='jet', extent=[0,1,0,1], interpolation='Gaussian')
        plt.colorbar(fraction=0.045)
        plt.xlabel('x',fontweight='bold'); plt.ylabel('y',fontweight='bold')
        plt.xticks(fontweight='bold'); plt.yticks(fontweight='bold');
        
        plt.subplot(4,4, index+1+8)
        plt.imshow(pred[value,:,:], cmap='jet', extent=[0,1,0,1], interpolation='Gaussian')
        plt.colorbar(fraction=0.045)
        plt.xlabel('x',fontweight='bold'); plt.ylabel('y',fontweight='bold')
        plt.xticks(fontweight='bold'); plt.yticks(fontweight='bold');
        ...
        plt.imshow(np.abs(pred[value,:,:]-y_test[value,:,:]), cmap='jet', extent=[0,1,0,1], 
                   vmin=0, vmax=0.001, interpolation='Gaussian')
        plt.xlabel('x', fontweight='bold'); plt.ylabel('y', fontweight='bold'); 
...
"""
torch.save(model, 'model/WNO_darcy_cwt_v2p1')
scipy.io.savemat('results/wno_results_darcy_cwt_v2p1.mat', mdict={'x_test':x_test.cpu().numpy(),
